...
import img1 from "../assets/team6.jpg";
import img2 from "../assets/team5.jpg";
import img3 from "../assets/team2.jpg";
import img4 from "../assets/team3.jpg";
import img5 from "../assets/team4.jpg";
import img6 from "../assets/team1.jpg";
...
const CelebrityLandingPage = () => {
  return (
    <div className="font-sans text-pink-900 bg-white">
      {/* Hero Section */}
      <section className="bg-pink-100 py-8 text-center h-screen">
        <PhotographerFloat />
        <img
          src={logo}
          alt="Company Logo"
        ...
        <h2 className="text-4xl font-bold mb-4">Catch the Buzz, Live!</h2>
      ...
      <section className="bg-white py-16 relative overflow-hidden">
        ...
        <div className="flex justify-center items-end gap-2 flex-wrap max-w-[1200px] mx-auto px-4">
          {celebs.map((celeb, index) => (
            <div
              key={index}
              className={`overflow-hidden w-[80px] md:w-[130px] ${celeb.height} transition-all duration-300 transform hover:scale-125 hover:z-10`}
              style={{
