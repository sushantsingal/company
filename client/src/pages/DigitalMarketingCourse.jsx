    ...
    <div className="bg-white text-gray-800">
      ...
      <div className="py-16 px-4 md:px-20">
              <div className="grid gap-20 md:grid-cols-2 py-6">
                ...
                <div>
                  {/* Intro */}
                  <h2 className="text-black text-lg py-4">Learn Digital Marketing the Practical Way</h2>
      ...
      <div className="py-16 px-4 md:px-20">
              <div className="grid gap-20 md:grid-cols-2 py-6">
                <div>
                  {/* Intro */}
                  <h2 className="text-black text-lg py-4">Learn from Experts Who Know the Industry</h2>
                  <p className="text-md text-gray-700 font-medium leading-relaxed mb-2">
